...
//      me = mui->getBEInterface()->get("Collector/FU0/EcalBarrel/EBCosmicTask/Cut/EBCT energy cut EB+01");
...
//      me = mui->getBEInterface()->get("Collector/FU0/EcalBarrel/EBCosmicTask/Sel/EBCT energy sel EB+01");
