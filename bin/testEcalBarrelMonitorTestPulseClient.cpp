...
void *pth1(void *) {
  ...
  while ( stay_in_loop && ! exit_now ) {
    ...
    mui->subscribeNew("*/EcalBarrel/EBTestPulseTask/Gain01/EBTPT shape EB+01 G01");
    mui->subscribeNew("*/EcalBarrel/EBTestPulseTask/Gain01/EBTPT amplitude EB+01 G01");
    mui->subscribeNew("*/EcalBarrel/EBTestPulseTask/Gain06/EBTPT shape EB+01 G06");
    mui->subscribeNew("*/EcalBarrel/EBTestPulseTask/Gain06/EBTPT amplitude EB+01 G06");
    mui->subscribeNew("*/EcalBarrel/EBTestPulseTask/Gain12/EBTPT shape EB+01 G12");
    mui->subscribeNew("*/EcalBarrel/EBTestPulseTask/Gain12/EBTPT amplitude EB+01 G12");
...
//      me = mui->get("Collector/FU0/EcalBarrel/EBTestPulseTask/Gain01/EBTPT amplitude EB+01 G01");
      me = mui->get("EcalBarrel/Sums/EBTestPulseTask/Gain01/EBTPT amplitude EB+01 G01");
...
//      me = mui->get("Collector/FU0/EcalBarrel/EBTestPulseTask/Gain06/EBTPT amplitude EB+01 G06");
      me = mui->get("EcalBarrel/Sums/EBTestPulseTask/Gain06/EBTPT amplitude EB+01 G06");
      h = UtilsClient::getHisto<TProfile2D*>(me);
      if ( h ) {
        c2->cd();
        h->SetOption("col");
...
//      me = mui->get("Collector/FU0/EcalBarrel/EBTestPulseTask/Gain12/EBTPT amplitude EB+01 G12");
      me = mui->get("EcalBarrel/Sums/EBTestPulseTask/Gain12/EBTPT amplitude EB+01 G12");
      h = UtilsClient::getHisto<TProfile2D*>(me);
      if ( h ) {
        c3->cd();
        h->SetOption("col");
...
//      me = mui->get("Collector/FU0/EcalBarrel/EBTestPulseTask/Gain01/EBTPT shape EB+01 G01");
      me = mui->get("EcalBarrel/Sums/EBTestPulseTask/Gain01/EBTPT shape EB+01 G01");
      h = UtilsClient::getHisto<TProfile2D*>(me);
      if ( h ) {
        c4->cd();
        h->SetOption("lego");
...
//      me = mui->get("Collector/FU0/EcalBarrel/EBTestPulseTask/Gain06/EBTPT shape EB+01 G06");
      me = mui->get("EcalBarrel/Sums/EBTestPulseTask/Gain06/EBTPT shape EB+01 G06");
      h = UtilsClient::getHisto<TProfile2D*>(me);
      if ( h ) {
        c5->cd();
        h->SetOption("lego");
...
//      me = mui->get("Collector/FU0/EcalBarrel/EBTestPulseTask/Gain12/EBTPT shape EB+01 G12");
      me = mui->get("EcalBarrel/Sums/EBTestPulseTask/Gain12/EBTPT shape EB+01 G12");
      h = UtilsClient::getHisto<TProfile2D*>(me);
      if ( h ) {
        c6->cd();
        h->SetOption("lego");
...
int main(int argc, char** argv) {
  ...
  mui->subscribe("*/EcalBarrel/EBTestPulseTask/Gain01/EBTPT shape EB+01 G01");
  mui->subscribe("*/EcalBarrel/EBTestPulseTask/Gain01/EBTPT amplitude EB+01 G01");
  mui->subscribe("*/EcalBarrel/EBTestPulseTask/Gain06/EBTPT shape EB+01 G06");
  mui->subscribe("*/EcalBarrel/EBTestPulseTask/Gain06/EBTPT amplitude EB+01 G06");
  mui->subscribe("*/EcalBarrel/EBTestPulseTask/Gain12/EBTPT shape EB+01 G12");
  mui->subscribe("*/EcalBarrel/EBTestPulseTask/Gain12/EBTPT amplitude EB+01 G12");

  CollateMonitorElement* cme;

  cme = mui->collateProf2D("EBTPT shape EB+01 G01", "EBTPT shape EB+01 G01", "EcalBarrel/Sums/EBTestPulseTask/Gain01");
  mui->add(cme, "*/EcalBarrel/EBTestPulseTask/Gain01/EBTPT shape EB+01 G01");

  cme = mui->collateProf2D("EBTPT amplitude EB+01 G01", "EBTPT amplitude EB+01 G01", "EcalBarrel/Sums/EBTestPulseTask/Gain01");
  mui->add(cme, "*/EcalBarrel/EBTestPulseTask/Gain01/EBTPT amplitude EB+01 G01");

  cme = mui->collateProf2D("EBTPT shape EB+01 G06", "EBTPT shape EB+01 G06", "EcalBarrel/Sums/EBTestPulseTask/Gain06");
  mui->add(cme, "*/EcalBarrel/EBTestPulseTask/Gain06/EBTPT shape EB+01 G06");

  cme = mui->collateProf2D("EBTPT amplitude EB+01 G06", "EBTPT amplitude EB+01 G06", "EcalBarrel/Sums/EBTestPulseTask/Gain06");
  mui->add(cme, "*/EcalBarrel/EBTestPulseTask/Gain06/EBTPT amplitude EB+01 G06");

  cme = mui->collateProf2D("EBTPT shape EB+01 G12", "EBTPT shape EB+01 G12", "EcalBarrel/Sums/EBTestPulseTask/Gain12");
  mui->add(cme, "*/EcalBarrel/EBTestPulseTask/Gain12/EBTPT shape EB+01 G12");

  cme = mui->collateProf2D("EBTPT amplitude EB+01 G12", "EBTPT amplitude EB+01 G12", "EcalBarrel/Sums/EBTestPulseTask/Gain12");
  mui->add(cme, "*/EcalBarrel/EBTestPulseTask/Gain12/EBTPT amplitude EB+01 G12");
