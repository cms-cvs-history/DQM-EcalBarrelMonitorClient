...
*/
EBMonitorClientWebInterface::EBMonitorClientWebInterface(std::string theContextURL, std::string theApplicationURL, MonitorUserInterface ** _mui_p)
  : WebInterface(theContextURL, theApplicationURL, _mui_p)
{
  ...
  */
  ...
  GifDisplay * dis = new GifDisplay(getApplicationURL(), "350px","10px", "800px", "800px", "MyGifDisplay");
...
*/
void EBMonitorClientWebInterface::handleCustomRequest(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
...
*/
void EBMonitorClientWebInterface::CustomRequestResponse(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
