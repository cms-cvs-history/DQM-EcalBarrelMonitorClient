...
int main(int argc, char** argv) {
  ...
  mui->subscribe("EcalCosmic/Cut/EBCT amplitude (cut) SM*");
  mui->subscribe("EcalCosmic/Sel/EBCT amplitude (sel) SM*");
  ...
  while ( stay_in_loop ) {
      ...
      mui->subscribeNew("EcalCosmic/Cut/EBCT amplitude (cut) SM*");
      mui->subscribeNew("EcalCosmic/Sel/EBCT amplitude (sel) SM*");
...
//            if ( status == "end-of-run" ) stay_in_loop = false;
          ...
          me = mui->get("Collector/FU0/EcalCosmic/Cut/EBCT amplitude (cut) SM01");
          if ( me ) {
          ...
          me = mui->get("Collector/FU0/EcalCosmic/Sel/EBCT amplitude (sel) SM01");
          if ( me ) {
            MonitorElementT<TNamed>* ob = dynamic_cast<MonitorElementT<TNamed>*> (me);
            if ( ob ) {
              TProfile2D* h = dynamic_cast<TProfile2D*> (ob->operator->());
